  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <h1 className="text-2xl lg:text-3xl font-bold mb-8 lg:mb-12 text-center" style={{ color: '#3A7E53' }}>
          Visite libre & dégustation<br />
          des cuvées Tradition
        </h1>
        ...
        <div className="mb-8 mt-4">
          <h2 className="text-2xl font-semibold mb-6 text-center" style={{ color: '#3A7E53' }}>Horaires</h2>
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-center gap-3 mb-6">
              <button
                ...
                style={morningStartIndex === 0 ? {} : { color: '#3A7E53' }}
              >
              ...
              {morningTimes.map((time) => (
                <Button
                  ...
                  style={selectedTime === time ? { backgroundColor: '#3A7E53' } : {}}
                >
                  {time}
                </Button>
              ))}
              <button
                ...
                style={morningStartIndex + visibleSlotsCount >= allMorningTimes.length ? {} : { color: '#3A7E53' }}
              >
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-center gap-3">
              <button
                ...
                style={afternoonStartIndex === 0 ? {} : { color: '#3A7E53' }}
              >
                <ChevronLeft className="w-5 h-5" />
              </button>
              ...
              <button
                ...
                style={afternoonStartIndex + visibleSlotsCount >= allAfternoonTimes.length ? {} : { color: '#3A7E53' }}
              >
                <ChevronRight className="w-5 h-5" />
              </button>
            </div>
          ...
          <div className="flex justify-center gap-8 mb-8 text-muted-foreground">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>5 € / personne</span>
            </div>
            <div className="flex items-center gap-2">
              <Wine className="w-5 h-5" style={{ color: '#3A7E53' }} />
              <span>5 vins</span>
            </div>
            <div className="flex items-center gap-2">
              <Users className="w-5 h-5" style={{ color: '#3A7E53' }} />
              <span>1 à 10 personnes</span>
            </div>
          </div>
        </div>
        ...
        {/* Participants */}
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-6 text-center" style={{ color: '#3A7E53' }}>Participants</h2>
        ...
        {/* Langues */}
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-6 text-center" style={{ color: '#3A7E53' }}>Langues</h2>
          <div className="flex justify-center gap-4">
            <Button
              ...
              style={selectedLanguage === "Français" ? { backgroundColor: '#3A7E53' } : {}}
            >
              Français
            </Button>
            <Button
              ...
              style={selectedLanguage === "English" ? { backgroundColor: '#3A7E53' } : {}}
            >
              English
            </Button>
          </div>
